...
1. LCZ Classification Implementation and Code. File:[code/LCZ classfication.js](code/LCZclassfication.js)
2. Influence Zone Raster Clipping and Landscape Pattern Index Calculation. File:[code/clip zone.py](code/clipzone.py)
